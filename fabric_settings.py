FABRIC = {
    "vagrant": {
        ...
        "DB_PASS": "garrett", # Live database password
        ...
        "PROJECT_NAME": "turbosaur", # Unique identifier for project
        "PROJECT_PATH": "/vagrant/turbosaur",
        ...
        "REPO_URL": "git@github.com:turbosaurus/turbosaur.git", # Git or Mercurial remote repo URL for the project
        "REPO_BRANCH": "master",
        "LINUX_DISTRO": "wheezy",
    },
    "development": {
